...
import {
  getAllSyllabusAction,
  getListSyllabusAction,
  getSingleEditAction,
...
const Syllabus = () => {
  ...
  const { singleToEditSyllabus, error: singleToEditSyllabusError } =
    useSelector((state) => state.getSingleToEditSyllabus);
  const { success: putSyllabusSuccess, error: putSyllabusError } = useSelector(
    (state) => state.putSyllabus
  );
